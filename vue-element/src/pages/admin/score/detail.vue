...
export default {
  ...
  data() {
    return {
      urls: {
        detailUrl: '/api/admin/score/detail/',
        mergeUrl: '/api/admin/score/update'
      },
      formModel: {},
      formItems: [
        {label: '用户', key: 'userId', type: 'select',optionUrl:'/api/user/userList'},
        {label: '水表', key: 'water', type: 'number'},
        {label: '电表', key: 'electricity', type: 'number'},
        {label: '燃气', key: 'gas', type: 'number'},
