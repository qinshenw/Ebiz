  ...
  <a-card :bordered="false">
    <el-form :inline="true" :model="formSearch" class="demo-form-inline" size="small">
      ...
      <el-form-item>
        ...
        <a-button type="success" @click="detail(0)" style="margin-left: 6px" v-if="user.role === 'admin'">添加</a-button>
      </el-form-item>
    ...
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column prop="water" label="水表"/>
      <el-table-column prop="electricity" label="电表"/>
      <el-table-column prop="gas" label="气"/>
...
export default {
  ...
  methods: {
    ...
    detail: function (id) {
      this.$router.push("/score/detail?id=" + id);
    },
    del: function (id) {
      post("/api/admin/score/delete/" + id).then(() => {
    ...
    search: function () {
      ...
      post("/api/admin/score/list", this.formSearch).then(res => {
